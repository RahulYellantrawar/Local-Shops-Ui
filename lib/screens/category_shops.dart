...
class CategoryShops extends StatefulWidget {
  static const routeName = '/catShops';

  const CategoryShops({super.key});

  @override
  State<CategoryShops> createState() => _CategoryShopsState();
}
...
class _CategoryShopsState extends State<CategoryShops> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedCategory =
        Provider.of<Categories>(context, listen: false).findById(catId);
